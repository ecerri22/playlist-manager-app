      ...
      <div style={{height: "85%"}}>
        ...
        <div className="flex flex-row gap-8	 w-full h-full" >
          ...
          <div style={{width: "30%"}} className="col-start-3 col-end-4 row-start-1 flex flex-col justify-between" >
            <div style={{height: "45%"}} className="col-start-3 col-end-5 row-start-1 row-end-2 bg-gray-400 bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg px-6 py-5 flex flex-col hover:cursor-pointer ">
            ...
            <div style={{height: "45%"}} className="col-start-3 col-end-5 row-start-2 row-end-3 bg-gray-400 bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg px-6 py-5 flex flex-col hover:cursor-pointer">
